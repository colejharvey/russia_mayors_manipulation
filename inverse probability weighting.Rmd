...
w <- ipwtm(
  ...
  denominator = ~ treated.mod.1lag + treated.mod.2lag + urgov.mod + lnAvgSalary.mod + comp.scale.mod + known.opp.mayor +  margin.most.recent +  dem.mod  + years.with.elections + appointed.share.mod + urvoteshare.1lag + turncoef.1lag + n.precincts,
  id = city_id,
  timevar=year.x,
  type="first",
  data = data_long_sort)
